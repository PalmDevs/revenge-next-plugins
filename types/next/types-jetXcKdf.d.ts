...
type UnionToIntersection<Union> = (
	...
	? Intersection & Union
	: never
type BeforeHook<T extends UnknownFunction = UnknownFunction> =
	OverloadUnion<T> extends infer U
		? 0 extends 1 & U
			...
			: UnionToIntersection<
				...
				>
		: never
type InsteadHook<T extends UnknownFunction = UnknownFunction> =
	OverloadUnion<T> extends infer U
		? 0 extends 1 & U
			?
			...
			: UnionToIntersection<
				...
				>
		: never
type AfterHook<T extends UnknownFunction = UnknownFunction> =
	OverloadUnion<T> extends infer U
		? 0 extends 1 & U
			? (result: any) => any
			: UnionToIntersection<
...
declare namespace ReactNative$1 {
...
type AssetId = number
type PackagerAsset = ReactNative$1.AssetsRegistry.PackagerAsset
...
declare let AssetsRegistry$1: ReactNative$1.AssetsRegistry
declare namespace index_d_exports$1 {
	export {
		AssetsRegistry$1 as AssetsRegistry,
		AssetsRegistryModuleId,
		addAssetOverride,
		getAssetByName,
		getAssetIdByName,
 ...
 */
declare function getAssetByName(
	name: string,
	type?: Asset['type'],
): Asset | undefined
/**
 ...
 */
declare function getAssetsByName(
	name: string,
 ...
 * @param type The preferred asset type, defaults to the current preferred type.
 */
declare function getAssetIdByName(
	name: string,
	type?: Asset['type'],
): AssetId | undefined
/**
...
type RunFilterReturnExportsOptions<ReturnNamespace extends boolean = boolean> =
	RunFilterOptions &
		If<
			ReturnNamespace,
			{
...
> = RunFilterReturnExportsOptions<ReturnNamespace> & {
	...
	>
type LookupModulesResult<F extends Filter, O extends LookupModulesOptions> = [
 ...
 * ```
 */
declare function lookupModules<F extends Filter>(
	filter: F,
): Generator<LookupModulesResult<F, object>, undefined>
declare function lookupModules<
	F extends Filter,
	const O extends F extends Filter<any, infer WE>
		? If<WE, LookupModulesOptions<boolean, false, false>, LookupModulesOptions>
		: never,
 ...
 * ```
 */
declare function lookupModule<F extends Filter>(
	filter: F,
): LookupModulesResult<F, object> | LookupNotFoundResult
declare function lookupModule<
	F extends Filter,
	const O extends F extends Filter<any, infer WE>
		? If<WE, LookupModulesOptions<boolean, false, false>, LookupModulesOptions>
		: never,
 ...
 * ```
 */
declare function lookupModuleByImportedPath<T = any>(
	path: string,
): [exports: T, id: Metro.ModuleID] | []
declare namespace wait_d_exports {
	export {
		BaseWaitForModulesOptions,
		WaitForModulesCallback,
		WaitForModulesOptions,
		WaitForModulesResult,
 ...
 * ```
 */
declare function waitForModules<F extends Filter>(
	filter: F,
	callback: WaitForModulesCallback<WaitForModulesResult<F, object>>,
): WaitForModulesUnsubscribeFunction
declare function waitForModules<
 ...
 * ```
 */
declare function waitForModuleByImportedPath<T = any>(
	path: string,
 ...
 * ```
 */
declare function getModule<F extends Filter>(
	filter: F,
 ...
 * ```
 */
declare function getModuleByImportedPath<T>(
	path: string,
...
type ModuleInitializedCallback = (
	id: Metro.ModuleID,
	exports: Metro.ModuleExports,
) => void
type ModuleFinishedImportingCallback = (
	id: Metro.ModuleID,
	path: string,
) => void
/**
 ...
 */
declare function onAnyModuleInitialized(
 ...
 * @returns A function that unregisters the callback.
 */
declare function onModuleInitialized(
	id: Metro.ModuleID,
	callback: ModuleInitializedCallback,
): () => void
/**
 ...
 * @returns A function that unregisters the callback.
 */
declare function onModuleFinishedImporting(
 ...
 * @returns A function that unregisters the callback.
 */
declare function onAnyModuleFirstRequired(
 ...
 * @returns A function that unregisters the callback.
 */
declare function onModuleFirstRequired(
	id: Metro.ModuleID,
	callback: ModuleFirstRequiredCallback,
): () => void
 ...
 */
declare function getModuleDependencies(
	id: Metro.ModuleID,
 ...
 */
declare function getInitializedModuleExports(
	id: Metro.ModuleID,
 ...
 */
declare function isModuleExportBad(
...
type PluginApiModulesFinders = typeof get_d_exports &
	typeof lookup_d_exports &
	typeof wait_d_exports & {
...
type BeforeJSXCallback<E extends ElementType> = (
	args: [element: E, props: ElementTypeProps<E>, key?: Key$1 | undefined],
) => Parameters<AnyJSXFactoryFunction>
type InsteadJSXCallback<E extends ElementType> = (
	args: [element: E, props: ElementTypeProps<E>, key?: Key$1 | undefined],
	jsx: AnyJSXFactoryFunction,
) => ReturnType<AnyJSXFactoryFunction> | null
type AfterJSXCallback<E extends ElementType> = (
 ...
 * @returns A function to unpatch.
 */
declare function afterJSX<E extends ElementType>(
	type: E,
 ...
 * @returns A function to unpatch.
 */
declare function beforeJSX<E extends ElementType>(
	type: E,
 ...
 * @returns A function to unpatch.
 */
declare function insteadJSX<E extends ElementType>(
	type: E,
 ...
 * @returns A function to unregister the callback.
 */
declare function onRunApplicationFinished(
	callback: RunApplicationCallback,
): () => void
//#endregion
...
type PluginApiExtensionsOptions = {}
/**
 ...
 * ```
 */
type PluginDecorateApi<
	O extends PluginApiExtensionsOptions = PluginApiExtensionsOptions,
	S extends keyof PluginApiInLifecycleMap<O> = keyof PluginApiInLifecycleMap<O>,
...
//# sourceMappingURL=types-jetXcKdf.d.ts.map
