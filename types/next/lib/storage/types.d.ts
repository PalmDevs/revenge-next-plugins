import { AnyObject, DeepPartial } from '../../types-cJK__Kwg.js'
...
type StorageSubscription<T extends AnyObject = AnyObject> = (
	v: DeepPartial<T>,
) => void
declare function Storage<T extends AnyObject>(
	this: Storage<T>,
	path: string,
 ...
 */
declare function getStorage<T extends AnyObject = AnyObject>(
	path: string,
	options?: StorageOptions<T>,
): Storage<T>
