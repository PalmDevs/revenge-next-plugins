		...
		<AlertModal
			...
			extraContent={
				<>
					...
					<Text color="text-feedback-critical" variant="text-xs/semibold">
						Note: Asset IDs and module IDs are not consistent between app
						launches and app versions respectively and should only be used when
						absolutely needed.
					</Text>
				</>
			}
